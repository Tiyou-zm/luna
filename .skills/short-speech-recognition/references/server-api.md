...
| Endpoint | `https://app-b9plzy10uj29-api-Aa2PZnjEw5NL-gateway.appmiaoda.com/server_api` |
| 网关 URL（含 API ID 前缀） | `https://app-b9plzy10uj29-api-Aa2PZnjEw5NL-gateway.appmiaoda.com/server_api` |
| Method | POST |
| Content-Type | application/json |
| third_part_domain | `app-b9plzy10uj29-api-Aa2PZnjEw5NL-gateway.appmiaoda.com` |
...
async function callShortSpeechRecognition(
  ...
  const response = await fetch("https://app-b9plzy10uj29-api-Aa2PZnjEw5NL-gateway.appmiaoda.com/server_api", {
    method: "POST",
    headers: {
      "Content-Type": "application/json",
...
serve(async (req: Request): Promise<Response> => {
  ...
  // --- 调用上游 API ---
  const upstream = await fetch("https://app-b9plzy10uj29-api-Aa2PZnjEw5NL-gateway.appmiaoda.com/server_api", {
    method: "POST",
    headers: {
      "Content-Type": "application/json",
      "X-Gateway-Authorization": `Bearer ${apiKey}`,
