...
- **Endpoint**: `GET https://app-b9plzy10uj29-api-Aa2PZnjE80BL-gateway.appmiaoda.com/company_three/get`
...
async function verifyCompanyThreeFactors(
  ...
  const response = await fetch(
    `https://app-b9plzy10uj29-api-Aa2PZnjE80BL-gateway.appmiaoda.com/company_three/get?${params.toString()}`,
    {
      method: "GET",
      headers: {
        "Content-Type": "application/json;charset=UTF-8",
...
- **third_part_domain**: `app-b9plzy10uj29-api-Aa2PZnjE80BL-gateway.appmiaoda.com`
