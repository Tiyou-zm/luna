...
| Endpoint | `POST https://app-b9plzy10uj29-api-DLEO7vB8pQba-gateway.appmiaoda.com/v1/image_generation` |
| 认证模式 | `platform_managed` |
| Auth Header | `X-Gateway-Authorization: Bearer ${INTEGRATIONS_API_KEY}` |
| Content-Type | `application/json` |
| Third-party Domain | `app-b9plzy10uj29-api-DLEO7vB8pQba-gateway.appmiaoda.com` |
...
async function generateImages(
  ...
  const response = await fetch(
    "https://app-b9plzy10uj29-api-DLEO7vB8pQba-gateway.appmiaoda.com/v1/image_generation",
    {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
