...
| Endpoint | `POST https://app-b9plzy10uj29-api-ra5EZDjVyjVa-gateway.appmiaoda.com/v2/tools/trending_lists/vertical` |
| Auth 模式 | `platform_managed`（traefik: true） |
| Auth Header | `X-Gateway-Authorization: Bearer ${INTEGRATIONS_API_KEY}` |
| Content-Type | `application/json` |
| Third-party Domain | `app-b9plzy10uj29-api-ra5EZDjVyjVa-gateway.appmiaoda.com` |
...
async function queryVerticalTrendingList(
  ...
  const response = await fetch(
    "https://app-b9plzy10uj29-api-ra5EZDjVyjVa-gateway.appmiaoda.com/v2/tools/trending_lists/vertical",
    {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
