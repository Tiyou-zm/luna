...
| third_part_domain | `app-b9plzy10uj29-api-Q9KWnzwVQMk9-gateway.appmiaoda.com` |
...
| Endpoint | `POST https://app-b9plzy10uj29-api-Q9KWnzwVQMk9-gateway.appmiaoda.com/v1/images/editing/expand` |
...
| Endpoint | `GET https://app-b9plzy10uj29-api-rLobR6vwZJJ9-gateway.appmiaoda.com/v1/images/editing/expand/{task_id}` |
| Content-Type | `application/json` |
...
| Endpoint | `GET https://app-b9plzy10uj29-api-AalZkPVdZX8L-gateway.appmiaoda.com/v1/images/editing/expand` |
| Content-Type | `application/json` |
...
async function createExpandTask(
  ...
  const response = await fetch(
    "https://app-b9plzy10uj29-api-Q9KWnzwVQMk9-gateway.appmiaoda.com/v1/images/editing/expand",
    {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
...
async function queryExpandTask(taskId: string): Promise<TaskDetail> {
  const response = await fetch(
    `https://app-b9plzy10uj29-api-rLobR6vwZJJ9-gateway.appmiaoda.com/v1/images/editing/expand/${encodeURIComponent(taskId)}`,
    {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
...
async function listExpandTasks(pageNum = 1, pageSize = 30): Promise<TaskDetail[]> {
  const url = new URL(
    "https://app-b9plzy10uj29-api-AalZkPVdZX8L-gateway.appmiaoda.com/v1/images/editing/expand",
  );
