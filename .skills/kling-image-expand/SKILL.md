...
| 功能 | 方法 | 端点 |
|------|------|------|
| 创建扩图任务 | POST | `https://app-b9plzy10uj29-api-Q9KWnzwVQMk9-gateway.appmiaoda.com/v1/images/editing/expand` |
| 查询单个任务 | GET  | `https://app-b9plzy10uj29-api-rLobR6vwZJJ9-gateway.appmiaoda.com/v1/images/editing/expand/{task_id}` |
| 查询任务列表 | GET  | `https://app-b9plzy10uj29-api-AalZkPVdZX8L-gateway.appmiaoda.com/v1/images/editing/expand` |
