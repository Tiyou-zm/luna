...
| Endpoint | `POST https://app-b9plzy10uj29-api-BYdwQyx58E6L-gateway.appmiaoda.com/caipiao/class` |
| Auth | `platform_managed`，`X-Gateway-Authorization: Bearer ${INTEGRATIONS_API_KEY}` |
| Content-Type | `application/json` |
| Third-party Domain | `app-b9plzy10uj29-api-BYdwQyx58E6L-gateway.appmiaoda.com` |
...
async function queryCaipiaoClass(): Promise<CaipiaoClassItem[]> {
  const response = await fetch(
    "https://app-b9plzy10uj29-api-BYdwQyx58E6L-gateway.appmiaoda.com/caipiao/class",
    {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
