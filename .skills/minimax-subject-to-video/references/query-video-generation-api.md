...
| Endpoint | `GET https://app-b9plzy10uj29-api-GYX1bq2l5vWa-gateway.appmiaoda.com/v1/query/video_generation` |
| Auth | `platform_managed`（`X-Gateway-Authorization: Bearer ${INTEGRATIONS_API_KEY}`） |
| Content-Type | 无请求体 |
| third_part_domain | `app-b9plzy10uj29-api-GYX1bq2l5vWa-gateway.appmiaoda.com` |
