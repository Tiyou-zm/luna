...
| Endpoint | `POST https://app-b9plzy10uj29-api-Aa2PqMJnJGwL-gateway.appmiaoda.com/v1/text/chatcompletion_v2` |
| Third-party Domain | `app-b9plzy10uj29-api-Aa2PqMJnJGwL-gateway.appmiaoda.com` |
...
async function callMiniMaxChat(request: ChatCompletionRequest): Promise<ChatCompletionResponse> {
  const response = await fetch(
    "https://app-b9plzy10uj29-api-Aa2PqMJnJGwL-gateway.appmiaoda.com/v1/text/chatcompletion_v2",
    {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
