...
- **Endpoint**: `POST https://app-b9plzy10uj29-api-o9wN0mk1DAPa-gateway.appmiaoda.com/driverexam/query`
...
async function queryDrivingExamQuestions(
  ...
  const response = await fetch(
    `https://app-b9plzy10uj29-api-o9wN0mk1DAPa-gateway.appmiaoda.com/driverexam/query?${params.toString()}`,
    {
      method: "POST",
      headers: {
