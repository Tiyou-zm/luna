...
|------|------|----------|--------|
| 地理编码 | 地址 → 坐标 | `GET https://app-b9plzy10uj29-api-GaDwZ0j3erOY-gateway.appmiaoda.com/geocoding/v3/` | GET |
| 逆地理编码 | 坐标 → 地址 | `GET https://app-b9plzy10uj29-api-baBwZEjbe1X9-gateway.appmiaoda.com/reverse_geocoding/v3` | GET |
...
const response = await fetch(
  `https://app-b9plzy10uj29-api-GaDwZ0j3erOY-gateway.appmiaoda.com/geocoding/v3/?${params}`,
  {
    method: "GET",
    headers: {
